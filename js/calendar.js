...
const Calendar = (function() {
    ...
    function generateCalendar() {
        ...
        const datesWithTasks = Storage.getDatesWithTasks();
    ...
    function selectDate(date) {
        ...
        const dateString = formatDate(date);
        const tasks = Storage.getTasksByDate(dateString);
    ...
    function init() {
        ...
        document.querySelector('.calendar-item').addEventListener('click', showCalendar);
    }
